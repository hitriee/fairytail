...
public interface PostService {
    ...
    List<PostDto> readPostListLatest(Double lat, Double lng, Long userId) throws Exception; //주변 최신순 리스트 조회
    List<PostDto> readPostListLike(Double lat, Double lng, Long userId) throws Exception; //주변 좋아요순 리스트 조회
    ...
    List<PostDto> readAllPost(Long userId) throws Exception; //전체 지역의 모든 리스트 조회
