...
export default function Scene({ ...props }) {
  const { nodes, materials } = useSpline(
    "https://prod.spline.design/m2V8U0ABwL7tU26j/scene.splinecode"
  );
  ...
  return (
    <>
      ...
      <group {...props} dispose={null}>
        ...
        <group
          name="picture-2"
          position={[512.1, -144.89, -840.99]}
          rotation={[-0.1, 0, 0]}
          scale={[1.62, 1.61, 0.98]}
        >
          <mesh
            name="Rectangle3"
